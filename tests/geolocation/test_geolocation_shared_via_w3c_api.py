...
def set_prefs():
    """Set prefs"""
    return [
        ("geo.provider.network.url", "https://www.googleapis.com/geolocation/v1/geolocate?key"
...
def click_geolocation_button_trigger(web_page):
    ...
    """
    geolocation_button_selector = "button.w3-btn.w3-blue.w3-round[onclick='getLocation()']"
...
def is_location_marker_displayed(web_page):
    ...
    """
    location_marker = web_page.find_elements(By.CSS_SELECTOR, "div[aria-label='You are here!'][role='img']")
