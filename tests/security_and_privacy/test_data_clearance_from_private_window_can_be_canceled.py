...
def test_data_clearance_from_private_window_can_be_canceled(
    ...
    # Verify the end private session process is stopped and previously open tabs are still displayed
