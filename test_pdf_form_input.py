...
def test_pdf_form_fill(session, test_url):
    ...
    WebDriverWait(session, 10).until(EC.url_changes('foersom.com/net/HowTo/data/OoPdfFormExample.pdf'))
    ...
    print('The title of the tab should be blank !' + session.title + '! <- Nothing between those')
